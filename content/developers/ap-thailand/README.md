...
| logo | `/developers/ap-thailand/logo.svg` |
...
- Logo SVG under `public/developers/ap-thailand/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
