# Developer package: pruksa-holding
...
| logo | `/developers/pruksa-holding/logo.svg` |
...
- Logo SVG under `public/developers/pruksa-holding/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
