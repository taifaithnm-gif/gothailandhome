# Developer package: capitaland-thailand

## Compliance metadata

| Field | Value |
| --- | --- |
| slug | `capitaland-thailand` |
| verification_status | `platform_verified` |
| publish_ready | `true` |
| collected_at | `2026-07-14` |
| logo | `/developers/capitaland-thailand/logo.svg` |
...
- Logo SVG under `public/developers/capitaland-thailand/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
