# Developer package: major-development
...
| logo | `/developers/major-development/logo.svg` |
...
- Logo SVG under `public/developers/major-development/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
