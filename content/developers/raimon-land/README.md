...
| logo | `/developers/raimon-land/logo.svg` |
...
- Logo SVG under `public/developers/raimon-land/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
