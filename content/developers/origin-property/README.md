# Developer package: origin-property

## Compliance metadata

| Field | Value |
| --- | --- |
| slug | `origin-property` |
| verification_status | `platform_verified` |
| publish_ready | `true` |
| collected_at | `2026-07-14` |
| logo | `/developers/origin-property/logo.svg` |
...
- Logo SVG under `public/developers/origin-property/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
