# Developer package: lpn-development

## Compliance metadata

| Field | Value |
| --- | --- |
| slug | `lpn-development` |
| verification_status | `platform_verified` |
| publish_ready | `true` |
| collected_at | `2026-07-14` |
| logo | `/developers/lpn-development/logo.svg` |
...
- Logo SVG under `public/developers/lpn-development/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
