...
| logo | `/developers/assetwise/logo.svg` |
...
- Logo SVG under `public/developers/assetwise/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
