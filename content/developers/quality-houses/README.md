# Developer package: quality-houses
...
| logo | `/developers/quality-houses/logo.svg` |
...
- Logo SVG under `public/developers/quality-houses/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
