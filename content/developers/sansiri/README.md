...
| logo | `/developers/sansiri/logo.svg` |
...
- Logo SVG under `public/developers/sansiri/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
