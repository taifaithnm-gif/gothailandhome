...
| logo | `/developers/sc-asset/logo.svg` |
...
- Logo SVG under `public/developers/sc-asset/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
