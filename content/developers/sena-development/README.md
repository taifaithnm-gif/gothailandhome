# Developer package: sena-development
...
| logo | `/developers/sena-development/logo.svg` |
...
- Logo SVG under `public/developers/sena-development/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
