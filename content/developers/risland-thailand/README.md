# Developer package: risland-thailand
...
| logo | `/developers/risland-thailand/logo.svg` |
...
- Logo SVG under `public/developers/risland-thailand/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
