# Developer package: noble-development
...
| logo | `/developers/noble-development/logo.svg` |
...
- Logo SVG under `public/developers/noble-development/` is a **placeholder** until a rights-cleared official logo export is mirrored; see `logo.meta.json`
