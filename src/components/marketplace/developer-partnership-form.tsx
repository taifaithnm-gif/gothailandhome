  ...
  return (
    <form action={action} className="space-y-4 rounded-2xl border border-[var(--brand-line)] bg-white p-6 sm:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Field label={m.company}><input name="company" required className={inputClass} /></Field>
        <Field label={m.officialWebsite}><input name="official_website" className={inputClass} /></Field>
        <Field label={m.representative}><input name="representative" required className={inputClass} /></Field>
        <Field label={m.role}><input name="role" className={inputClass} /></Field>
        <Field label={m.projects}><input name="projects" className={inputClass} /></Field>
        <Field label={m.cooperationInterest}><input name="cooperation_interest" className={inputClass} /></Field>
