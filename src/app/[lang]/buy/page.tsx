...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    locale: lang,
    title: dict.meta.buyTitle,
    description: dict.meta.buyDescription,
    path: "/buy",
  });
}

export default async function BuyLandingPage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
  ...
  const allHref = localePath(lang, "/properties?listing_type=sale");

  return (
    <PageShell
      title={b.buyTitle}
      subtitle={b.buySubtitle}
      notice={b.trustNote}
      breadcrumbs={[
    ...
    >
      ...
      <SurfaceCard className="mb-8 p-5!" tone="soft">
        ...
        <p className="mt-2 text-sm font-medium text-[var(--brand-deep)]">
          {paged.total} {b.verifiedSaleCount}
        </p>
      </SurfaceCard>
